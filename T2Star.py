...
class T2Star():
	...
	# QUICK SUMMARY OF METHODS BELOW
	# T2StarNottingham - input array is [x, y, z, TE] and output is [x, y, z] in Milliseconds
	# T2StarJoao - input array is [TE, z, y, x] and output is [z, y, x] in Seconds - this was just for personal practice
    ...
    def T2StarJoao(self):
		"""
        Generates a T2* map from a series of volumes collected with different echo times. It's a rewritten version of T2StarNottingham with a few modifications.
        ...
        pixelArray : 4D/3D array
            ...
            are [TE, z, y, x].
        echoList : Array
            An array of the echo times used for the first dimension of the raw data.

        Returns
        -------
        t2Star : 3D array
            An array containing the T2* map generated by the function with T2* measured in seconds.
        r2star : 3D array
        """
        try:
            self.pixelArray[self.pixelArray == 0] = 1E-10
            ...
            with np.errstate(invalid='ignore', over='ignore'):
                ...
                for echo in range(numberEchoes):
                    te = self.echoList[echo] * 0.001 * matrixOnes # Conversion from ms to seconds 
    ...
    def R2Star(self):
		"""
        Generates a R2* map from a series of volumes collected with different echo times. It calls T2StarJoao().
        ...
        -------
        r2Star : 3D array
            An array containing the R2* map generated by the function with R2* measured in seconds.
        """
        try:
