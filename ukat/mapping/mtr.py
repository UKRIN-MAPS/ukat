...
class MTR:
    ...
    def __init__(self, pixel_array, affine, mask=None, moco=False):
        ...
        moco : bool, optional
            Default False
            If True, the MT on and MT off volumes will be registered to the
            average before the MTR is calculated.
        """
    ...
    def to_nifti(self, output_directory=os.getcwd(), base_file_name='Output',
        ...
        if maps == 'all' or maps == ['all']:
            maps = ['mtr_map', 'mt_on', 'mt_off', 'mask', 'deformation_field']
            ...
            for result in maps:
                if result == 'mtr' or result == 'mtr_map':
                    ...
                    deformation_field_nifti = nib.Nifti1Image(
                        self.deformation_field, affine=self.affine)
                    nib.save(deformation_field_nifti,
